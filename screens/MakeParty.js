                                                    ...
                                                    <View style={[styles.customToast, { height: 320, zIndex: 1000 }]}>
                                                        ...
                                                        <View style={[styles.row3, { marginLeft: 65, position: 'relative', top: 10 }]}>
                                                            <TouchableOpacity onPress={() => {
                                                                props.onCancel(); // Toast 숨기기
                                                                setToastVisible(false);              // 토스트 상태 false로 업데이트
                                                                onBack();                // Join 화면으로 돌아가기
                                                            }}>
                                                                <Text style={{ fontSize: 17, height: 30, marginTop: 355, marginLeft: 40, width: 70, textAlign: 'center', fontWeight: 'bold', position: 'relative', left: 14 }}>
                                                                    {typeof '닫기' === 'string' ? '닫기' : ''}
                                                                </Text>
                                                            </TouchableOpacity>
                                                        </View>
