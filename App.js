...
export default function App() {
  ...
  return (
    ...
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerStyle: { height: 120, backgroundColor: '#FCFAF7', elevation: 0, shadowOpacity: 0, borderBottomWidth: 0 }, headerTitleAlign: 'center', headerTitleStyle: { fontWeight: 'bold' } }}>
        {isAuthenticated ? (
          <>
            <Stack.Screen
              name="MainFrame"
